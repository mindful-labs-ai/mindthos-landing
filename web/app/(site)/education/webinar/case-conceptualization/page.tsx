...
const KEY_INFO = [
  ...
  },
  {
    icon: Ticket,
    label: '참가비',
    value: `${WEBINAR.price.toLocaleString('ko-KR')}원`,
    note: '토스페이먼츠 간편 결제',
  },
];
...
export default function CaseConceptualizationWebinarPage() {
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: '교육 프로그램', url: `${SITE_CONFIG.url}/education` },
    {
      ...
      url: `${SITE_CONFIG.url}${WEBINAR.path}`,
    },
  ]);
      ...
      >
        <div className="container">
          <div className="page-hero-content webinar-hero-content">
            <span className="section-pill">마음토스 웨비나 · 10월 6일 (화) 19:00</span>
            ...
            <p className="webinar-hero-note">
              구글 밋 온라인 라이브 · 참가비 {WEBINAR.price.toLocaleString('ko-KR')}원 ·
        ...
        <div className="container">
          <div className="webinar-apply-head">
            ...
            <p className="webinar-apply-sub">
              ...
              참가비 {WEBINAR.price.toLocaleString('ko-KR')}원. 신청 정보를 입력하고
              결제하시면 신청이 완료됩니다.
            </p>
