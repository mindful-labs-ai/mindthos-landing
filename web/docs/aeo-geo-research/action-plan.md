...
### A4. Bing Webmaster Tools에 sitemap 재등록 확인 (P0)
...
### B3. inline citation 규칙 + 자동 검증 (P1)
...
## Phase 3 — Entity / Authority 빌딩 (1-3개월)
...
|----|------|-------|--------|--------|--------|
| A1 | Anthropic 3-봇 + Bingbot 명시 | 1 | High | XS | — |
| A2 | FAQ 자동 주입 우선순위 하향 | 1 | Med | XS | — |
| A3 | SummaryBox = 직접 답 블록 | 1 | High | S | — |
| A4 | Bing Webmaster sitemap 확인 | 1 | High | XS | — |
| A5 | 검수 워크플로우 명문화 | 1 | Med | S | — |
| B1 | MedicalWebPage 스키마 | 2 | High | M | DB |
| B2 | Generic 저자 라벨링 ("마음토스 임상 심리 전문가") | 2 | Med-High | S | — |
| B3 | inline citation 의무·검증 | 2 | High | M | — |
| B4 | Listicle 템플릿 | 2 | High | L | 디자인 |
| B5 | Passage-level 가이드라인 | 2 | Med-High | S | — |
| B6 | References 의무화 | 2 | Med | S | — |
| C1 | Wikidata 등록 | 3 | High (장기) | M | 외부 인용자료 |
| C2 | LinkedIn + Crunchbase | 3 | Med-High | S | — |
| C3 | 한국 entity 빌딩 | 3 | High | XL | 분기별 |
| C4 | 검수 자문위원회 페이지 | 3 | High | L | 인선 |
...
이후:
- Month 2: B4 (Listicle 템플릿), C2 (LinkedIn·Crunchbase)
- Month 3: C1 (Wikidata), C4 (자문위원회)
- 지속: C3, D1, D2
